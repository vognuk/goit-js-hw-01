...
//приплюсовать полученное значение к total
//посчитать общую сумму введенных чисел
// проверить, что введенное значение это число
// если введено не число, то пропустить добавление к общей сумме
...
if (total.isNumber) {
        total = Number(input) + Number(prompt());
    console.log(total);
} else {
